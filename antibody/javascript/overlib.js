...
if(OLud('textsize'))var ol_textsize=0;//1;
if(OLud('captionsize'))var ol_captionsize=0;//1;
if(OLud('closesize'))var ol_closesize=0;//1;
if(OLud('fgclass'))var ol_fgclass="";
if(OLud('bgclass'))var ol_bgclass="";
if(OLud('cgclass'))var ol_cgclass="";
if(OLud('textpadding'))var ol_textpadding=0;//2;
if(OLud('textfontclass'))var ol_textfontclass="";
if(OLud('captionpadding'))var ol_captionpadding=0;//2;
...
if(OLud('width'))var ol_width=0;//200;
...
o3_width=0,o3_wrap=0,o3_wrapmax=0,o3_height= -1,o3_border=1,o3_base=0,o3_status="",o3_autostatus=0,o3_snapx=0,o3_snapy=0,
