 ...
 * @package    Antibodydb_Filter
 * @category   Filter
 */
class Antibodydb_Filter_Input extends Zend_Filter_Input
{
    ...
    public function __construct(array $data, $context, array $options = null)
    {
        ...
        $this->addFilterPrefixPath('Antibodydb_Filter', 'Antibodydb/Filter');
        $this->addValidatorPrefixPath('Antibodydb_Validate', 'Antibodydb/Validate');
