...
public class Channel extends JavaScriptObject {
  ...
  public final native Socket open(SocketListener listener) /*-{
    ...
    listener.@com.google.gwt.appengine.channel.client.SocketListener::setSocket(Lcom/google/gwt/appengine/channel/client/Socket;)(socket);
    ...
    socket.onerror = function(event) {
      listener.@com.google.gwt.appengine.channel.client.SocketListener::onError(Lcom/google/gwt/appengine/channel/client/SocketError;)(event);
    };
    return socket;
  }-*/;
}